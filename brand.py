...
\033[1;37m----------------------------------------------
 GITHUB     : AVINASH-BAU
 FACEBOOK   : AVINASH BRAND
 VERSION    :\u001b[32m 4.0\033[1;37m
 AVINASH BRAND KO CMD USE HAN VANA REXA LAGLA
 AVINASH FIRST UPDATE OF v8
 NEPAL !!!!!!
\033[1;37m----------------------------------------------""")
...
def nameask():
    ...
    if os.path.exists("data/name.xml") and os.path.getsize("data/name.xml") > 0:
        ...
        with open("data/name.xml", "w") as name_file_obj:
            ...
            print(" [\u001b[36m•\033[1;37m] YOUR NAME HAS BEEN CHANGED ")
            exit()
try:
...
def contact():
	clear()
	banner()
	print(" [\u001b[36m1\033[1;37m] frenzy_bau")
	print(" [\u001b[36m2\033[1;37m]100090956447369 ")
	linex()
	admin = input(" CHOOSE : ")
	if admin in ['1']:
		os.system('xdg-open https://www.facebook.com/profile.php?id=100090956447369')
		back()
	elif admin in ['2']:
		linex()
...
def passwrd():
	...
	linex()
	print(f" \u001b[36m>> \033[1;37m️USE 4G NETWORK TO CLONE")
	linex()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[AVINASH-BAU]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
